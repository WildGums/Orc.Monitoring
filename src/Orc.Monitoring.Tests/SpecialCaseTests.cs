...
public class SpecialCaseTests
{
    ...
    public void Setup()
    {
        ...
        _methodCallInfoPool = new MethodCallInfoPool(_loggerFactory);
        _callStack = new CallStack(_config, _methodCallInfoPool, _loggerFactory);
    ...
    public void StaticMethod_IsCorrectlyMonitored()
    {
        ...
        var monitor = new ClassMonitor(typeof(TestClass), _callStack, _config, _loggerFactory);
    ...
    public void ExtensionMethod_IsCorrectlyMonitored()
    {
        ...
        var monitor = new ClassMonitor(typeof(TestExtensions), _callStack, _config, _loggerFactory);
